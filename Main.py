...
def LoadData():
    ...
    for pokemon in sprite_pokemons:
        ...
        pos+=1
    LoadInfo()
#Funcion encargada de agregar nuevos pokemons descubiertos
...
def GameWindow():
    ...
    while run:
            ...
            for boton in sprite_botones:
                if(Mouse.colliderect(boton.rect)):
                    ...
                    if(boton.accion == "B_Down" and not Intro  and isConsolaOn):
                        ...
                        pygame.time.wait(100)
                    #Accion del boton para el rugido
                    if(boton.accion == "B_Rowr"):
                        if(isConsolaOn):
                            Rowr = True
                    #Acciones del boton de informacion 
                    if(boton.accion == "B_Info"):
                        if(not Menu_):
                            Info = not Info
                        pygame.time.wait(100)
                    #Acciones del boton de sonido
        ...
        if(isConsolaOn):
            ...
            #Cuando esta en la seccion Intro
            if(Intro):
                ...
                Wait = 1500
                Intro = False
            #Cuando esta en la seccion Info
            elif(Info):
                Info_ = ""
                if(posInfo == 0):
                    Info_ = infoP.split("\n")
                ...
                for line in Info_:
                    ...
                    y+=17
            #Cuando esta en la seccion Menu
            elif(Menu_):
                menu.draw(screen)
            else:
                for pokemon in sprite_pokemons:
                    if(pokemon.posicion == posicion):
                        ...
                        if(Rowr and pokemon.descubierto):
                            ...
                            Rowr = False
        #Accion cuando la consola esta apagada
        else:
